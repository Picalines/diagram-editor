...
public sealed class DiagramElementsController(ICreateDiagramElementUseCase createUseCase)
    : ControllerBase
{
    [Authorize]
    [HttpPost]
    public async Task<
        Results<Ok<CreateDiagramElementResponse>, NotFound, BadRequest, UnauthorizedHttpResult>
